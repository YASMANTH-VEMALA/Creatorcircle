...
export interface Notification {
  id: string;
  type: 'like' | 'comment' | 'comment_reply' | 'comment_like' | 'collab_request' | 'request_accepted' | 'request_rejected' | 'report_warning' | 'follow' | 'message';
  senderId: string;
  senderName: string;
...
class NotificationService {
  ...
  async markNotificationAsRead(userId: string, notificationId: string): Promise<void> {
    try {
      ...
      // Delete the notification once it has been viewed
  ...
  async createCommentNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        message: `${senderProfile.name || 'Unknown User'} commented: '${shortComment}' on your post.`
      });
    } catch (error) {
  ...
  async createCollaborationRequestNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        senderProfilePic: senderProfile.profilePhotoUrl,
        senderVerified: senderProfile.isVerified || false,
        message: `${senderProfile.name || 'Unknown User'} sent you a collaboration request: ${message}`
      });
    } catch (error) {
  ...
  async createCollaborationAcceptedNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        senderProfilePic: senderProfile.profilePhotoUrl,
        senderVerified: senderProfile.isVerified || false,
        message: `${senderProfile.name || 'Unknown User'} accepted your collaboration request.`
      });
    } catch (error) {
  ...
  async createRequestRejectedNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        senderProfilePic: senderProfile.profilePhotoUrl,
        senderVerified: senderProfile.isVerified || false,
        message: `${senderProfile.name || 'Unknown User'} rejected your collaboration request.`
      });
    } catch (error) {
  ...
  async createCommentReplyNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        message: `${senderProfile.name || 'Unknown User'} replied to your comment: '${shortReply}'`
      });
    } catch (error) {
  ...
  async createCommentLikeNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        relatedPostId: postId,
        relatedCommentId: commentId,
        message: `${senderProfile.name || 'Unknown User'} liked your comment.`
      });
    } catch (error) {
  ...
  async createFollowNotification(
    ...
    try {
      ...
      await this.createNotification(receiverId, {
        ...
        senderProfilePic: senderProfile.profilePhotoUrl,
        senderVerified: senderProfile.isVerified || false,
        message: `${senderProfile.name || 'Unknown User'} started following you!`
      });
    } catch (error) {
  ...
  async createMessageNotification(
    ...
    try {
      ...
      const shortText = textPreview ? (textPreview.length > 80 ? textPreview.substring(0, 80) + '...' : textPreview) : '';
      ...
      await this.createNotification(receiverId, {
        ...
        message: shortText ? `${senderProfile.name || 'Someone'}: ${shortText}` : `${senderProfile.name || 'Someone'} sent you a message`
      });
    } catch (error) {
