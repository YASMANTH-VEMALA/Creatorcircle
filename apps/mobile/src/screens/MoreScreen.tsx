...
const MoreScreen: React.FC = () => {
  ...
  // Premium status check removed - premium features coming soon
    ...
    <SafeAreaView style={styles.container} edges={['top','bottom']}>
      ...
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContentContainer}>
        ...
        <View style={styles.optionsSection}>
          ...
          <OptionItem icon="help-circle-outline" label="Help & Support" onPress={handleHelpSupport} />
          <OptionItem icon="information-circle-outline" label="About" onPress={handleAbout} />
        </View>
