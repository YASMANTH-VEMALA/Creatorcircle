  ...
  try {
    ...
    const SwipeableRow: React.FC<{ 
      ...
      const handleDelete = () => {
        Alert.alert(
          'Delete Chat',
          `Are you sure you want to delete your conversation with ${chat.otherUser?.name || 'Unknown User'}?`,
          [
          ...
          >
            <TouchableOpacity style={styles.chatContent} onPress={onPress}>
              <View style={styles.avatarContainer}>
                <Avatar
                  size="medium"
                  source={chat.otherUser?.profilePic}
                  fallback={chat.otherUser?.name ? chat.otherUser.name.charAt(0).toUpperCase() : 'U'}
              ...
              <View style={styles.chatInfo}>
                <View style={styles.headerRow}>
                  <View style={styles.nameContainer}>
                    <Text style={styles.userName}>{chat.otherUser?.name || 'Unknown User'}</Text>
